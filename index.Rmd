...
ggplot(trans_df%>%filter(age%in%c(10,15,20) & cohort<2065),aes(x = year, y = transition_prob, fill = to_name))+
    geom_area() +
    facet_grid(age ~ from_name) +
    labs(
      title = "Education transition probabilities for female by age in India",
      x = "Year",
...
E3.2 Plot the age and education distribution of the children of a Focal aged 65 in 2020, 2050, and 2080. Then look at how the age distribution of children with upper secondary & above education changes over time. What does this tell us about how educational progression changes across cohorts?
